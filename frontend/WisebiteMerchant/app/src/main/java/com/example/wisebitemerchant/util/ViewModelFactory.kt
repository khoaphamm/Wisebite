    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return when {
            ...
            modelClass.isAssignableFrom(ProfileViewModel::class.java) -> {
                ProfileViewModel(authRepository, storeRepository) as T
            }
            modelClass.isAssignableFrom(MerchantEditProfileViewModel::class.java) -> {
                MerchantEditProfileViewModel(authRepository, storeRepository) as T
            }
